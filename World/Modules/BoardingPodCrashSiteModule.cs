...
public sealed class BoardingPodCrashSiteModule
{
    ...
    {
        AddWallFragment(new Vector3(-1.35f, 1.55f, -1.35f), new Vector3(0.35f, 1.75f, 0.28f));
        AddWallFragment(new Vector3(1.32f, 1.35f, -1.35f), new Vector3(0.42f, 1.45f, 0.3f));
        AddWallFragment(new Vector3(-0.65f, 2.88f, -1.32f), new Vector3(0.9f, 0.24f, 0.34f));
        AddWallFragment(new Vector3(0.72f, 2.74f, -1.32f), new Vector3(0.7f, 0.32f, 0.28f));
        AddWallFragment(new Vector3(-1.05f, 0.28f, -1.32f), new Vector3(0.75f, 0.42f, 0.5f));
        AddWallFragment(new Vector3(1.08f, 0.22f, -1.25f), new Vector3(0.62f, 0.32f, 0.42f));
        AddWallFragment(new Vector3(-0.12f, 2.35f, -1.18f), new Vector3(0.32f, 0.72f, 0.22f));
    }

    private void AddDebrisField()
    {
        AddDetail(new Vector3(-0.8f, 0.08f, -1.34f), new Vector3(0.55f, 0.16f, 0.35f));
        AddDetail(new Vector3(0.55f, 0.06f, -1.1f), new Vector3(0.38f, 0.12f, 0.42f));
        AddDetail(new Vector3(-1.55f, 0.12f, -0.82f), new Vector3(0.42f, 0.24f, 0.3f));
        AddDetail(new Vector3(1.62f, 0.1f, -0.68f), new Vector3(0.46f, 0.2f, 0.32f));
        AddDetail(new Vector3(-0.42f, 0.07f, -0.28f), new Vector3(0.32f, 0.14f, 0.28f));
        AddDetail(new Vector3(0.36f, 0.09f, -1.34f), new Vector3(0.48f, 0.18f, 0.26f));
        AddDetail(new Vector3(-1.85f, 0.08f, -1.28f), new Vector3(0.5f, 0.16f, 0.24f));
        ...
        AddDetail(new Vector3(-3.35f, 0.1f, -1.38f), new Vector3(0.48f, 0.2f, 0.46f));
        AddDetail(new Vector3(3.32f, 0.11f, -1.22f), new Vector3(0.52f, 0.22f, 0.34f));

        AddSolid(new Vector3(-3.25f, 0.38f, -0.95f), new Vector3(0.9f, 0.76f, 0.72f));
        AddSolid(new Vector3(3.18f, 0.32f, -0.76f), new Vector3(0.82f, 0.64f, 0.68f));
        AddSolid(new Vector3(-2.35f, 0.28f, -0.92f), new Vector3(0.78f, 0.56f, 0.52f));
    }

    private void AddImpactFloorDetails()
    {
        AddScorchMark(new Vector3(0f, 0.012f, -0.86f), new Vector3(2.15f, 0.024f, 1.25f));
        AddScorchMark(new Vector3(-0.35f, 0.014f, -0.25f), new Vector3(1.45f, 0.028f, 0.72f));
        AddDetail(new Vector3(-1.15f, 0.035f, -0.92f), new Vector3(0.9f, 0.07f, 0.08f));
        AddDetail(new Vector3(1.12f, 0.035f, -0.72f), new Vector3(0.75f, 0.07f, 0.08f));
        AddDetail(new Vector3(0.48f, 0.04f, -0.55f), new Vector3(0.08f, 0.08f, 0.7f));
    }
