...
- **Weapon ammo and reload**: magazine ammo, reserve ammo, reload timing, and HUD reload status.
...
- **Weapon pickups and dropping**: world weapon pickups can be collected with E, and the current weapon can be dropped with G as a new world object.
